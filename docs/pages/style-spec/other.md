...
{{<Note theme="warning">}}
As of [v0.41.0](https://github.com/maplibre/maplibre-gl-js/blob/main/CHANGELOG.md#0410-october-11-2017), [property expressions](/ja-maplibre-gl-js-docs/style-spec/expressions) is the preferred method for styling features based on zoom level or the feature's properties. Zoom and property functions are still supported, but will be phased out in a future release.
{{</Note>}}
...
{{<Subtitle>}}
Required (except for <var>identity</var> functions) [array](/ja-maplibre-gl-js-docs/style-spec/types/#array).
{{</Subtitle>}}

A set of one input value and one output value is a "stop." Stop output values must be literal values (i.e. not functions or expressions), and appropriate for the property. For example, stop output values for a `fill-color` function property must be [colors](/ja-maplibre-gl-js-docs/style-spec/types/#color).


{{<Property headingLevel='3' id="function-property">property</Property>}}

{{<Subtitle>}}
Optional [string](/ja-maplibre-gl-js-docs/style-spec/types/#string).
{{</Subtitle>}}

If specified, the function will take the specified feature property as an input. See [Zoom Functions and Property Functions](/ja-maplibre-gl-js-docs/style-spec/types/#function-zoom-property) for more information.

{{<Property headingLevel='3' id="function-base">base</Property>}}

{{<Subtitle>}}
Optional [number](/ja-maplibre-gl-js-docs/style-spec/types/#number). Default is {{ref.function.base.default}}.
{{</Subtitle>}}
...
{{<Subtitle>}}
Optional [string](/ja-maplibre-gl-js-docs/style-spec/types/#string). One of `"identity"`, `"exponential"`, `"interval"`, or `"categorical"`.
{{</Subtitle>}}
...
{{<Subtitle>}}
Optional [string](/ja-maplibre-gl-js-docs/style-spec/types/#string). One of `"rgb"`, `"lab"`, `"hcl"`.
{{</Subtitle>}}
...
The rendered values of [color](/ja-maplibre-gl-js-docs/style-spec/types/#color), [number](/ja-maplibre-gl-js-docs/style-spec/types/#number), and [array](/ja-maplibre-gl-js-docs/style-spec/types/#array) properties are interpolated between stops. [Boolean](/ja-maplibre-gl-js-docs/style-spec/types/#boolean) and [string](/ja-maplibre-gl-js-docs/style-spec/types/#string) property values cannot be interpolated, so their rendered values only change at the specified stops.
...
A <var>value</var> (and <var>v0</var>, ..., <var>vn</var> for set operators) must be a [string](/ja-maplibre-gl-js-docs/style-spec/types/#string), [number](/ja-maplibre-gl-js-docs/style-spec/types/#number), or [boolean](/ja-maplibre-gl-js-docs/style-spec/types/#boolean) to compare the property value against.
